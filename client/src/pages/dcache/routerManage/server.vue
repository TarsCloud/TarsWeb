<template>
  <div>
    ...
    <let-table :data="tableData" :empty-msg="$t('common.nodata')" ref="pageTable">
      ...
      <let-table-column :title="$t('routerManage.idcArea')" prop="idc_area"></let-table-column>
      <let-table-column :title="$t('routerManage.serverName')" prop="server_name"></let-table-column>
      <let-table-column :title="$t('routerManage.ip')" prop="ip"></let-table-column>
      <let-table-column :title="$t('routerManage.binlogPort')" prop="binlog_port"></let-table-column>
