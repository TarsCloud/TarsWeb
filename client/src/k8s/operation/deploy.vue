      ...
      <el-collapse v-model="activeTab" accordion style="margin-top: 5px">
        ...
        <el-collapse-item name="0">
          ...
          >
            ...
            >
              <el-select
                v-model="k8sApplyModel.abilityAffinity"
                size="small"
                style="width: 95%"
              >
                <el-option
            ...
            <let-form-item
              v-if="k8sApplyModel.NodeSelector.length == 0"
              itemWidth="45%"
            >
              <el-button
                type="text"
                @click="addItems(0, k8sApplyModel.NodeSelector)"
              >
            ...
            <div v-for="(item, index) in k8sApplyModel.NodeSelector">
              <let-form-item
                :label="$t('nodeList.table.th.label')"
                itemWidth="15%"
              >
                <el-input
                  size="small"
              ...
              <el-button
                ...
                size="mini"
                circle
                @click="addItems(index, k8sApplyModel.NodeSelector)"
              ></el-button>
              <el-button
                type="danger"
                icon="el-icon-minus"
                size="mini"
                circle
                @click="delItems(index, k8sApplyModel.NodeSelector)"
              ></el-button>
            </div>
          </let-form>
        </el-collapse-item>
        ...
        <el-collapse-item name="1">
          ...
          >
            ...
            >
              <el-radio-group
                v-model="k8sApplyModel.HostNetwork"
                @change="changeKind"
              >
                <el-radio :label="true">{{ $t("common.true") }}</el-radio>
                <el-radio :label="false">{{ $t("common.false") }}</el-radio>
            ...
            >
              <el-radio-group
                v-model="k8sApplyModel.showHostPort"
                @change="changeKind"
              >
                <el-radio :label="true">{{ $t("common.true") }}</el-radio>
                <el-radio :label="false">{{ $t("common.false") }}</el-radio>
            ...
            <div v-if="k8sApplyModel.showHostPort" style="padding-right:30px;">
              <let-table :data="k8sApplyModel.HostPortArr">
                ...
                <let-table-column
                  :title="$t('deployService.table.th.hostPort')"
                >
                  <template slot="head" slot-scope="props">
                    <span class="required">{{ props.column.title }}</span>
                  </template>
        ...
        <el-collapse-item name="2">
          ...
          <div v-if="k8sApplyModel.mounts.length == 0">
            <el-button
              type="text"
              size="mini"
              @click="addDisk(0, k8sApplyModel.mounts)"
            ...
            <div v-for="(disk, index) in k8sApplyModel.mounts" :key="index">
              <el-card>
                <el-row :gutter="18">
                  <el-col :span="6">
                    <el-form-item
                      :label="$t('deployService.disk.diskName')"
                      required
                    >
                  ...
                  <el-col :span="6">
                    <el-form-item
                      :label="$t('deployService.disk.path')"
                      required
                    >
                ...
                <el-row>
                  <el-col :offset="9">
                    <el-button
                      type="primary"
                      size="mini"
                      @click="addDisk(index, k8sApplyModel.mounts)"
                    >
                      {{ $t("deployService.disk.addDisk") }}
                    </el-button>
                    <el-button
                      type="danger"
                      size="mini"
                      @click="delDisk(index, k8sApplyModel.mounts)"
                      style="margin-left: 20px"
                    >
            ...
            <el-row :gutter="20">
              <el-col :span="12">
                ...
                >
                  <el-input
                    :placeholder="
                      $t('deployService.resources.example') + ':1000'
                    "
                    v-model="k8sApplyModel.resources.limitCpu"
                    size="small"
              ...
              <el-col :span="12">
                ...
                >
                  <el-input
                    :placeholder="
                      $t('deployService.resources.example') + ':128'
                    "
                    v-model="k8sApplyModel.resources.limitMem"
                    size="small"
                    onkeyup="value=value.replace(/[^\d]/g,'')"
                  >
                ...
                >
                  <el-input
                    :placeholder="
                      $t('deployService.resources.example') + ':1000'
                    "
                    v-model="k8sApplyModel.resources.requestCpu"
                    size="small"
                    onkeyup="value=value.replace(/[^\d]/g,'')"
                  >
                    <template slot="append">milli CPUs</template>
                ...
                >
                  <el-input
                    :placeholder="
                      $t('deployService.resources.example') + ':128'
                    "
                    v-model="k8sApplyModel.resources.requestMem"
                    size="small"
                    onkeyup="value=value.replace(/[^\d]/g,'')"
                  >
                    <template slot="append">MiB</template>
