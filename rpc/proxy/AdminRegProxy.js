...
var __tars_AdminReg$reportNode$IE = function (nodeName) {
    var os = new TarsStream.TarsOutputStream();
    os.writeString(1, nodeName);
    return os.getBinBuffer();
};
...
var __tars_AdminReg$reportNode$PE = function (nodeName, __$PROTOCOL$VERSION) {
    var tup = new TarsStream.UniAttribute();
    tup.tupVersion = __$PROTOCOL$VERSION;
    tup.writeString("nodeName", nodeName);
    return tup;
...
tars.AdminRegProxy.prototype.reportNode = function (nodeName) {
    var version = this._worker.version;
    if (version === TarsStream.Tup.TUP_SIMPLE || version === TarsStream.Tup.TUP_COMPLEX) {
        return this._worker.tup_invoke("reportNode", __tars_AdminReg$reportNode$PE(nodeName, version), arguments[arguments.length - 1], __tars_AdminReg$reportNode$IF).then(__tars_AdminReg$reportNode$PD, __tars_AdminReg$reportNode$ER);
    } else {
        return this._worker.tars_invoke("reportNode", __tars_AdminReg$reportNode$IE(nodeName), arguments[arguments.length - 1], __tars_AdminReg$reportNode$IF).then(__tars_AdminReg$reportNode$ID, __tars_AdminReg$reportNode$ER);
    }
};
