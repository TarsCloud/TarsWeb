...
tars.PreparePatchInfo.prototype.readFromObject = function(json) { 
    _hasOwnProperty.call(json, "bPreparePatching") && (this.bPreparePatching = json.bPreparePatching);
    _hasOwnProperty.call(json, "iPercent") && (this.iPercent = json.iPercent);
    _hasOwnProperty.call(json, "iModifyTime") && (this.iModifyTime = json.iModifyTime);
    _hasOwnProperty.call(json, "sVersion") && (this.sVersion = json.sVersion);
    _hasOwnProperty.call(json, "sResult") && (this.sResult = json.sResult);
...
tars.PreparePatchRequest.prototype.readFromObject = function(json) { 
    ...
    _hasOwnProperty.call(json, "md5") && (this.md5 = json.md5);
    _hasOwnProperty.call(json, "ostype") && (this.ostype = json.ostype);
    _hasOwnProperty.call(json, "specialNodeList") && (this.specialNodeList.readFromObject(json.specialNodeList));
    _hasOwnProperty.call(json, "filepath") && (this.filepath = json.filepath);
    return this;
};
