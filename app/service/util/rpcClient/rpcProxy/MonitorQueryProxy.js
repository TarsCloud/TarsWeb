...
tars.MonitorQueryReq._readFrom = function (is) {
    ...
    tmp.conditions = is.readList(3, true, TarsStream.List(tars.Condition));
    tmp.indexs = is.readList(4, true, TarsStream.List(TarsStream.String));
    tmp.groupby = is.readList(5, true, TarsStream.List(TarsStream.String));
    return tmp;
};
tars.MonitorQueryReq.prototype._writeTo = function (os) {
    ...
    os.writeList(3, this.conditions);
    os.writeList(4, this.indexs);
    os.writeList(5, this.groupby);
};
...
var __XXtars_MonitorQuery$query$IF = {
    "name" : "query",
    "return" : "int32",
    "arguments" : [{
        "name" : "req",
...
var __XXtars_MonitorQuery$query$IE = function (req) {
    var os = new TarsStream.TarsOutputStream();
    os.writeStruct(1, req);
    return os.getBinBuffer();
};

var __XXtars_MonitorQuery$query$ID = function (data) {
    try {
...
var __XXtars_MonitorQuery$query$PE = function (req, __$PROTOCOL$VERSION) {
...
var __XXtars_MonitorQuery$query$PD = function (data) {
    try {
...
var __XXtars_MonitorQuery$query$ER = function (data) {
...
tars.MonitorQueryProxy.prototype.query = function (req) {
    ...
    if (version === TarsStream.Tup.TUP_SIMPLE || version === TarsStream.Tup.TUP_COMPLEX) {
        return this._worker.tup_invoke("query", __XXtars_MonitorQuery$query$PE(req, version), arguments[arguments.length - 1], __XXtars_MonitorQuery$query$IF).then(__XXtars_MonitorQuery$query$PD, __XXtars_MonitorQuery$query$ER);
    } else {
        return this._worker.tars_invoke("query", __XXtars_MonitorQuery$query$IE(req), arguments[arguments.length - 1], __XXtars_MonitorQuery$query$IF).then(__XXtars_MonitorQuery$query$ID, __XXtars_MonitorQuery$query$ER);
    }
};
tars.MonitorQueryProxy.query = __XXtars_MonitorQuery$query$IF;
